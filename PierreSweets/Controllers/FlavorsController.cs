...
namespace PierreSweets.Controllers
{
  public class FlavorsController : Controller
  {
    ...
    public ActionResult AddTreat(int id)
    {
      ...
      ViewBag.TreatId = new SelectList(_db.Treats, "TreatId", "Name", "Description");
      return View(thisFlavor);
    }
    ...
    { 
      ...
      ApplicationUser currentUser = await _userManager.FindByIdAsync(userId);
      #nullable enable
      TreatFlavor? joinEntity = _db.TreatFlavors.FirstOrDefault(join => (join.TreatId == treatId && join.TreatId == flavor.FlavorId));
      #nullable disable
